...
async def spamraid(interaction: discord.Interaction, message: str):
    ...
    try:
        ...
        # 2. Send the main message 5 times with delay
        for _ in range(5):
        ...
        await interaction.followup.send("❌ შეცდომა მოხდა სპამის გაგზავნისას.", ephemeral=True)
...
async def onlyone(interaction: discord.Interaction, message: str):
    ...
    try:
        ...
        await interaction.followup.send("❌ შეცდომა მოხდა შეტყობინების გაგზავნისას.", ephemeral=True)
